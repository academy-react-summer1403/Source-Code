...
const LikeDissLike = ({ likeCount, dissLikeCount, currentLikeCount, currentDissLikeCount }) => {
    ...
    return (
        <>
            <div className="flex flex-row justify-between gap-4 dark:bg-slate-500 dark:text-white bg-gray-200 text-black py-2 px-4 rounded-3xl text-center font-serif">
                <button
