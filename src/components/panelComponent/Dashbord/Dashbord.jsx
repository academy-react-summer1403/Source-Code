...
function Dashbord() {
  return (
    <div className="">
      ...
      <div className='border grid grid-cols-3 border-indigo-400 w-11/12 h-44 mx-auto mt-10 rounded-2xl relative'>
        <div className='h-2/3 mt-3 mr-2 flex'>
          <div className='text-gray-500 mt-4 mr-3'> نام و نام خانوادگی  : </div>
          <div className='text-indigo-600 mt-4 mr-2'> بیتا قنبری </div>
        </div>
        <div className='h-2/3 mt-3 mr-2 flex'>
          <div className='text-gray-500 mt-4 mr-3'> تاریخ تولد  : </div>
          <div className='text-indigo-600 mt-4 mr-2'> 1402/03/26 </div>
        </div>
        <div className='h-2/3 mt-3 mr-2 flex'>
          <div className='text-gray-500 mt-4 mr-3'> شماره همراه  : </div>
          <div className='text-indigo-600 mt-4 mr-2'> 09031129980 </div>
        </div>
        <div className='h-2/3 mt-3 mr-2 flex'>
          <div className='text-gray-500 mt-4 mr-3'> شماره ملی  : </div>
          <div className='text-indigo-600 mt-4 mr-2'> 1234567890 </div>
        </div>
        <div className='h-2/3 mt-3 mr-2 flex'>
          <div className='text-gray-500 mt-4 mr-3'> ایمیل  : </div>
          <div className='text-indigo-600 mt-4 mr-2'> bitaghanbari@gmail.com </div>
        </div>
        <div className='absolute bottom-0 text-indigo-600 left-0 w-2/12 h-1/4 leading-10 text-center border border-t-indigo-400 border-r-indigo-400  rounded-tr-2xl rounded-bl-2xl'> ویرایش </div>
      </div>
      <div className='flex'>
        <div className='w-1/2 h-96 mt-20 mr-5'>
          <div className='text-2xl mt-3 mr-3'> آخرین دوره ثبت شده </div>
          <div className='w-full h-1/5 mt-10 flex shadow-2xl'>
            <div className='w-1/5 h-max my-auto mx-2'><img src="public/ang.png" alt="" /></div>
            <div className='w-4/5'>
              <div className='mr-3 mt-1'> آموزش رایگان html </div>
              <div className='flex h-1/2 mt-1 justify-between'>
                <div className='text-xs mt-4 mr-2 text-gray-400'> دکتر بحرالعلوم </div>
        ...
        <div className='w-1/2 h-96 mt-20 mr-5 ml-5'>
