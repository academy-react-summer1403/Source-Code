  ...
  return (
    <div className="">
      <div className="h-12 flex border-b border-b-slate-300">
        <div className="w-1/2">
          <div className="w-1/3 h-full">
            <div className="mt-2 w-max my-auto mr-5 h-min">داشبورد</div>
          </div>
        </div>
      ...
      <div className='border grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:h-44 md:h-60 h-80 border-indigo-400 w-11/12 mx-auto mt-10 rounded-2xl relative'>
        ...
        <div className='absolute bottom-0 text-indigo-600 left-0 w-2/12 md:h-1/4 h-1/6 leading-10 text-center border border-t-indigo-400 border-r-indigo-400  rounded-tr-2xl rounded-bl-2xl' > ویرایش </div>
      </div>
