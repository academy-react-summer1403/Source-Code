...
// import { toggleFavoriteAPI } from "../../../core/services/api/Courses/fav-course";
import toast, { Toaster } from "react-hot-toast";

const CourseFavorite = ({ id, userFavorite }) => {
  const [isFavorite, setIsFavorite] = useState(userFavorite);
  // console.log("userFavorite", userFavorite);
  // console.log("iddd", id);
  const toggleFavoriteCourse = async (id) => {
