...
import CourseMiniDescription from "../Buttons/CourseMiniDescription";
    ...
    <div className="mx-auto rounded-2xl flex mt-7">
      ...
      >
        <div className="shadow-lg bg-white rounded-2xl -mt-5 mb-12 flex ">
          <div className="w-1/2">
            <img className="py-3 pr-4" src={detail.tumbImageAddress ? detail.tumbImageAddress : "public/ang.png"} />
          </div>
          <div className="">
              ...
              <div className="bg-slate-200 w-max rounded-2xl flex">
                <div className="flex py-1">
                  <div className="mr-3 my-auto">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M3.75337 8.72021L3.7467 11.8469C3.7467 12.6935 4.40004 13.6002 5.20004 13.8669L7.3267 14.5735C7.69337 14.6935 8.30004 14.6935 8.67337 14.5735L10.8 13.8669C11.6 13.6002 12.2534 12.6935 12.2534 11.8469V8.75355"
                        stroke="#263238"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                  ...
                  <div className="mr-1 text-xs">{detail.teacherName}</div>
                </div>
                <div className="flex py-1">
                  <div className="mr-2 my-auto">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M10.9401 2.6665C12.2334 2.6665 13.2734 3.71317 13.2734 4.99984C13.2734 6.25984 12.2734 7.2865 11.0267 7.33317C10.9734 7.3265 10.9134 7.3265 10.8534 7.33317"
                        stroke="#263238"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M2.77335 9.7065C1.16002 10.7865 1.16002 12.5465 2.77335 13.6198C4.60669 14.8465 7.61335 14.8465 9.44669 13.6198C11.06 12.5398 11.06 10.7798 9.44669 9.7065C7.62002 8.4865 4.61335 8.4865 2.77335 9.7065Z"
                        stroke="#263238"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M12.2267 13.3335C12.7067 13.2335 13.16 13.0402 13.5334 12.7535C14.5734 11.9735 14.5734 10.6868 13.5334 9.90683C13.1667 9.62683 12.72 9.44016 12.2467 9.3335"
                        stroke="#263238"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                ...
                <div className="flex py-1">
                  <div className="mr-2 my-auto">
                    ...
                    >
                      <path
                        d="M14.44 6.95984L13.7867 9.74651C13.2267 12.1532 12.12 13.1265 10.04 12.9265C9.70671 12.8998 9.3467 12.8398 8.96004 12.7465L7.84004 12.4798C5.06004 11.8198 4.20004 10.4465 4.85337 7.65984L5.50671 4.86651C5.64004 4.29984 5.80004 3.80651 6.00004 3.39984C6.78004 1.78651 8.1067 1.35318 10.3334 1.87984L11.4467 2.13984C14.24 2.79318 15.0934 4.17318 14.44 6.95984Z"
                        stroke="#263238"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M10.04 12.9266C9.62665 13.2066 9.10665 13.4399 8.47332 13.6466L7.41998 13.9932C4.77332 14.8466 3.37998 14.1332 2.51998 11.4866L1.66665 8.85324C0.813317 6.20657 1.51998 4.80657 4.16665 3.95324L5.21998 3.60657C5.49332 3.5199 5.75332 3.44657 5.99998 3.3999C5.79998 3.80657 5.63998 4.2999 5.50665 4.86657L4.85332 7.6599C4.19998 10.4466 5.05998 11.8199 7.83998 12.4799L8.95998 12.7466C9.34665 12.8399 9.70665 12.8999 10.04 12.9266Z"
                        stroke="#263238"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M8.42664 5.68652L11.66 6.50652"
                        stroke="#263238"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                      <path
                        d="M7.77332 8.2666L9.70665 8.75994"
                        stroke="#263238"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
...
export default SecondViewCourses;
