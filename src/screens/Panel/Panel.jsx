  ...
  return (
    <div className={`${darkMode && "dark"}`}>
      <div className="bg-indigo-50 xl:w-screen w-fit h-fit">
        ...
        <div className="flex  mx-auto w-min text-asBlack-300 dark:bg-slate-700">
          <div className="hidden lg:inset-y-0 lg:block lg:w-64 mx-10">
            <div>
              <div className="flex-col lg:col-span-4 overflow-y-auto">
                <div className=" border border-lastCoursesBorder lg:h-[500px] xl:h-[700px] bg-gradient-to-b from-indigo-500 to-indigo-800  dark:from-slate-500 dark:to-slate-800 rounded-lg shadow-xl my-10">
          ...
          <div className="mx-auto">
            ...
            <div className="z-30 lg:w-[900px] bg-white pb-10 w-screen border dark:bg-slate-600 dark:text-white lg:ml-10 mx-auto lg:my-10 rounded-2xl shadow-xl">
              {count === 1 && <Dashbord />}
              {count === 2 && <EditProfile />}
              {count === 3 && <MyCourses />}
              {count === 4 && <CheangePass />}
