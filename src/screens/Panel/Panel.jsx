    ...
    <div className="bg-indigo-50">
          ...
          <div className="fixed inset-0 z-40 flex">
            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-white">
                ...
                <div className="h-0 flex-1 overflow-y-auto pt-5 pb-4 bg-rangBg text-asBlack-300">
                  <div className="flex flex-shrink-0 items-center px-4"></div>
                  <div className="z-40 mx-auto xl:h-screen xl:w-80  rounded-lg shadow-xl my-10 relative ">
                    <div className="mt-5 w-[100%] h-24 flex">
                      <div className="w-[40%]">
                        <div className="w-[45%] h-[45%]">
                          <div className="w-20 h-20 my-auto xl:mt-2 mx-[35%]">
                            <Avatar
                      ...
                      <div className="w-1/2 mr-5">
                        <div className="text-asBlack-100 font-bold text-xl text-center mt-4">
                          {" "}
                          Zahradar{" "}
                        </div>
                    ...
                    <div
                      className={
                        (count === 1 ? "text-purple-400" : "") +
                        " mt-10 w-full h-10 flex pr-5 pt-2"
                      }
                    >
                      <svg
                        className=""
                    ...
                    <div
                      className={
                        ...
                        " mt-3 w-full h-10 flex pr-5 pt-2"
                      }
                    >
                      <svg
                        className="mt-2 mr-2"
                    ...
                    <div className="mt-3 w-full h-10 flex pr-5 pt-2">
                      <svg
                        className="mr-2 mt-2"
                        xmlns="http://www.w3.org/2000/svg"
                        width="23"
      ...
      <div className="flex h-screen mx-auto w-min text-asBlack-300">
        ...
        <div className="mx-auto">
          <div className=" top-0 z-10 bg-rangBg border-lastCoursesBorder rounded-2xl shadow-xl mx-5 my-4 border pl-1 pt-1 sm:pl-3 sm:pt-3 lg:hidden">
            <button
              type="button"
